...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedRbacAndFeatureFlags() {
        ...
        List<PermissionSeed> permissionSeeds = List.of(
                ...
                // Dashboard
                new PermissionSeed("DASHBOARD_VIEW", "DASHBOARD", "VIEW", "View system dashboard"),
                ...
                new PermissionSeed("GROUP_ROOM_VIEW", "GROUP_ROOM", "VIEW", "View mentor group room"),
                new PermissionSeed("GROUP_ROOM_MANAGE", "GROUP_ROOM", "MANAGE", "Manage mentor group room"),
                new PermissionSeed("GROUP_MESSAGE_SEND", "GROUP_ROOM", "MESSAGE_SEND", "Send messages in group chat"),
                new PermissionSeed("GROUP_MESSAGE_MODERATE", "GROUP_ROOM", "MESSAGE_MODERATE", "Moderate group messages"),
                new PermissionSeed("GROUP_ANNOUNCEMENT_MANAGE", "GROUP_ROOM", "ANNOUNCEMENT_MANAGE", "Manage group announcements"),
                new PermissionSeed("GROUP_TASK_VIEW", "GROUP_TASK", "VIEW", "View group tasks"),
                new PermissionSeed("GROUP_TASK_CREATE", "GROUP_TASK", "CREATE", "Create group tasks"),
                new PermissionSeed("GROUP_TASK_UPDATE", "GROUP_TASK", "UPDATE", "Update group tasks"),
                new PermissionSeed("GROUP_TASK_DELETE", "GROUP_TASK", "DELETE", "Delete group tasks"),
                new PermissionSeed("GROUP_TASK_MANAGE", "GROUP_TASK", "MANAGE", "Manage group tasks"),
                new PermissionSeed("SUBMISSION_GRADE", "SUBMISSION", "GRADE", "Grade and review student submissions"),
                new PermissionSeed("GROUP_SUBMISSION_VIEW", "GROUP_ROOM", "SUBMISSION_VIEW", "View group submissions"),
                new PermissionSeed("GROUP_SUBMISSION_CREATE", "GROUP_ROOM", "SUBMISSION_CREATE", "Create group submissions"),
                new PermissionSeed("GROUP_SUBMISSION_REVIEW", "GROUP_ROOM", "SUBMISSION_REVIEW", "Review and grade group submissions"),
                new PermissionSeed("GROUP_MEMBER_MANAGE", "GROUP_ROOM", "MEMBER_MANAGE", "Manage group members and roles"),
                new PermissionSeed("GROUP_ROOM_SETTINGS_UPDATE", "GROUP_ROOM", "SETTINGS_UPDATE", "Update group room settings"),
                new PermissionSeed("ADMIN_GROUP_ROOM_VIEW_ALL", "GROUP_ROOM", "ADMIN_VIEW_ALL", "Admin view all group rooms"),
                new PermissionSeed("ADMIN_GROUP_ROOM_AUDIT_VIEW", "GROUP_ROOM", "ADMIN_AUDIT_VIEW", "Admin view group room audit logs"),
                // System Config & RBAC
                new PermissionSeed("ROLE_VIEW", "ROLE", "VIEW", "View system roles"),
                new PermissionSeed("ROLE_UPDATE", "ROLE", "UPDATE", "Update system roles"),
                new PermissionSeed("PERMISSION_VIEW", "PERMISSION", "VIEW", "View system permissions"),
                new PermissionSeed("PERMISSION_UPDATE", "PERMISSION", "UPDATE", "Update system permissions"),
        ...
        Set<String> mentorPerms = Set.of(
                ...
                "PHASE_VIEW",
                "ASSIGNMENT_VIEW",
                "SUBMISSION_VIEW", "SUBMISSION_DOWNLOAD", "SUBMISSION_OPEN_LINK", "SUBMISSION_GRADE",
                "ASSESSMENT_VIEW", "ASSESSMENT_SCORE",
                "GROUP_VIEW", "GROUP_CREATE", "GROUP_UPDATE", "GROUP_MEMBER_ADD", "GROUP_MEMBER_REMOVE",
                "GROUP_ROOM_VIEW", "GROUP_ROOM_MANAGE", "GROUP_MESSAGE_SEND", "GROUP_MESSAGE_MODERATE",
                "GROUP_ANNOUNCEMENT_MANAGE", "GROUP_TASK_VIEW", "GROUP_TASK_CREATE", "GROUP_TASK_UPDATE", "GROUP_TASK_DELETE", "GROUP_TASK_MANAGE",
                "GROUP_SUBMISSION_VIEW", "GROUP_SUBMISSION_REVIEW", "GROUP_MEMBER_MANAGE", "GROUP_ROOM_SETTINGS_UPDATE"
        );
        for (Permission p : permissionMap.values()) {
        ...
        Set<String> studentPerms = Set.of(
                ...
                "GROUP_ROOM_VIEW", "GROUP_MESSAGE_SEND", "GROUP_TASK_VIEW",
                "GROUP_SUBMISSION_VIEW", "GROUP_SUBMISSION_CREATE"
        );
        for (Permission p : permissionMap.values()) {
        ...
        List<FeatureSeed> featureSeeds = List.of(
                ...
                new FeatureSeed("GROUP_CHAT_ENABLED", "GROUP_ROOM", "Phòng chat nhóm", "Cho phép trao đổi tin nhắn trong nhóm mentor", true, Set.of("ADMIN", "MENTOR", "STUDENT")),
                new FeatureSeed("GROUP_TASK_ENABLED", "GROUP_ROOM", "Quản lý công việc nhóm", "Cho phép tạo và theo dõi task làm việc nhóm", true, Set.of("ADMIN", "MENTOR", "STUDENT")),
                new FeatureSeed("GROUP_SUBMISSION_ENABLED", "GROUP_ROOM", "Nộp bài theo nhóm", "Cho phép nộp bài tập/đồ án theo nhóm", true, Set.of("ADMIN", "MENTOR", "STUDENT")),
                new FeatureSeed("GROUP_FILE_ATTACHMENT_ENABLED", "GROUP_ROOM", "Đính kèm tệp trong phòng nhóm", "Cho phép tải lên file đính kèm trong chat nhóm", true, Set.of("ADMIN", "MENTOR", "STUDENT"))
        );
    ...
    private void grantPermissionIfNotFound(Role role, Permission permission, boolean granted) {
        rolePermissionRepository.findByRoleAndPermission(role, permission)
                .ifPresentOrElse(
                        rp -> {
                            if ("STUDENT".equals(role.getRoleCode()) && "COMPANY_VIEW".equals(permission.getPermissionCode()) && Boolean.TRUE.equals(rp.getGranted())) {
                                rp.setGranted(false);
