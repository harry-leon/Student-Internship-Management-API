...
public interface MentorService {
    ...
    com.se191116.studymanagement.model.dto.response.MentorDetailResponse getMentorDetail(Integer mentorId);
    Page<MentorResponse> getMentors(Pageable pageable);
    Page<MentorResponse> getMentors(String search, String department, Pageable pageable);
