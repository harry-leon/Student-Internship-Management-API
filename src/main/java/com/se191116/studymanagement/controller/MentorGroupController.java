...
@RestController
@RequestMapping({"/api/mentor-groups", "/api/groups"})
@SecurityRequirement(name = "bearerAuth")
@RequiredArgsConstructor
public class MentorGroupController {

    private final MentorGroupService mentorGroupService;
    private final com.se191116.studymanagement.service.GroupRoomService groupRoomService;
    ...
    @PreAuthorize("hasAuthority('GROUP_MEMBER_ADD')")
    ...
    @PreAuthorize("hasAuthority('GROUP_MEMBER_REMOVE')")
    ...
    public ResponseEntity<SuccessResponse<Void>> removeMember(
        ...
        groupRoomService.removeMember(groupId, studentId, currentUser);
    ...
    @PreAuthorize("hasAuthority('GROUP_JOIN')")
    @PostMapping("/join")
