...
@RestController
@RequestMapping({"/api/notifications", "/api/me/notifications"})
...
public class NotificationController {
    ...
    public ResponseEntity<SuccessResponse<Page<NotificationResponse>>> getMyNotifications(
        ...
        Page<NotificationResponse> notifications = notificationService.getMyNotifications(userDetails.getUsername(), status, type, pageable);
