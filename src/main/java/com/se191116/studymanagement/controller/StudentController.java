...
public class StudentController {
    ...
    public ResponseEntity<SuccessResponse<Page<StudentResponse>>> getStudents(
        ...
        Page<StudentResponse> students = studentService.getStudents(search, major, pageable);
        return ResponseEntity.ok(SuccessResponse.success(students, "Get list student successfully"));
    }

    @GetMapping("/{student_id}")
    @PreAuthorize("hasAnyAuthority('STUDENT_VIEW', 'STUDENT_VIEW_DETAIL')")
    ...
    @PreAuthorize("hasAuthority('STUDENT_VIEW_DETAIL')")
